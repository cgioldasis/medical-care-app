    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .requestMatchers("/api/user/**").hasAnyAuthority(Role.ADMIN.name(), Role.DOCTOR.name())
                                .requestMatchers("/api/user/user-status/all").hasAnyAuthority(Role.ADMIN.name())
                                .requestMatchers("/api/doctor/**").hasAnyAuthority(Role.ADMIN.name(), Role.DOCTOR.name())
                                .requestMatchers("/api/user/register").permitAll()
                                .requestMatchers("/api/specialization/all").permitAll()
                                .requestMatchers("/api/medicine/**").hasAnyAuthority(Role.ADMIN.name(), Role.DOCTOR.name())
                                ...
                                .requestMatchers("/api/patient/**").hasAnyAuthority(Role.ADMIN.name(), Role.DOCTOR.name())
